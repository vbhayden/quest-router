...
const spirits = [
    ...
    factory.createSpirit(names.NEPTY, false, 20, "Blue Cave", "From maze beginning, left."),
    ...
    // Shilf Start
    factory.createSpirit(names.SHILF, false, 45, "Isle of Skye", "Colleen's other room."),
    ...
    factory.createSpirit(names.SHILF, false, 30, "Limelin", "By a bushel in the port."),
    factory.createSpirit(names.SHILF, false, 30, "Limelin", "By the fence of the condemned house."),
    factory.createSpirit(names.SHILF, false, 30, "Limelin", "By the gate of the grain field."),
    factory.createSpirit(names.SHILF, false, 30, "Limelin", "Behind the jail house."),
    factory.createSpirit(names.SHILF, false, 20, "Limelin", "By the shackles in the jail."),
    factory.createSpirit(names.SHILF, false, 30, "Limelin", "At the base of the pillar in the castle gardens."),
    factory.createSpirit(names.SHILF, false, 15, "Limelin", "Behind the relief in the grand hall 1."),
    factory.createSpirit(names.SHILF, false, 15, "Limelin", "Behind the relief in the grand hall 2."),
    factory.createSpirit(names.SHILF, false, 40, "Limelin", "Search the bookshelf in the castle library."),
